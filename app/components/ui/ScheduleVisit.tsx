...
export default function ScheduleVist({
    ...
    return (
        <>
            ...
            <div id="dialog" aria-labelledby="dialog-title" className={`${onest.className} fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm`}> 
                <div className="fixed inset-0 bg-gray-900/50 transition-opacity"></div>
                <div className="flex items-center justify-center w-full h-full p-4 text-center focus:outline-none">
