...
export default function MapSection({ properties = [] }: any) {
                ...
                {selected && (
                    ...
                    >
                        <div className="max-w-sm sm:max-w-sm md:max-w-md h-auto min-h-72 max-h-112">
                            ...
                            <img
                                src={selected.image}
                                className="rounded mb-2 w-full h-24 sm:h-28 md:h-32 object-cover"
                            />
                            ...
                            <div className="md:flex flex-col justify-between gap-2 pt-5 md:w-full">
  ...
  <div
    ...
    `}
  >
    <div className="relative w-full max-w-md rounded-2xl bg-black text-white p-6">
