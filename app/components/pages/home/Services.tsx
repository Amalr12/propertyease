                ...
                <div className="grid md:grid-cols-4  gap-4 p-5 ">
                    <div className="bg-[#0c0c0c] rounded flex flex-col items-center justify-center p-6">
                        ...
                        <div className="flex items-center justify-center w-10 h-10 border border-yellow-600 rounded-full mb-3">
                            <GoHomeFill className="text-yellow-500 text-lg" />
                        </div>
                    ...
                    <div className="bg-[#0c0c0c] rounded flex flex-col items-center justify-center p-6">
                        ...
                        <div className="flex items-center justify-center w-10 h-10 border border-yellow-600 rounded-full mb-3">
                            <VscDeviceCamera className="text-yellow-500 text-lg" />
                        </div>
                    ...
                    <div className="bg-[#0c0c0c] rounded flex flex-col items-center justify-center p-6">
                        ...
                        <div className="flex items-center justify-center w-10 h-10 border border-yellow-600 rounded-full mb-3">
                            <HiMiniBuildingOffice2 className="text-yellow-500 text-lg" />
                        </div>
                    ...
                    <div className="bg-[#0c0c0c] rounded flex flex-col items-center justify-center p-6">
                        ...
                        <div className="flex items-center justify-center w-10 h-10 border border-yellow-600 rounded-full mb-3">
                            <BsFillBrightnessHighFill className="text-yellow-500 text-lg" />
                        </div>
